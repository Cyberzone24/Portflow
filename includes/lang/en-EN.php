...
if (isset($_GET['nav'])) {
    ...
    $nav['portview'] = [
        ...
        'columns' => [
            ...
            'patchpanelCaption' => 'Patch Panel',
            'patchpanelPortCaption' => 'PP Port',
            'cableName' => 'Cable',
            'roomCaption' => 'Room',
            'wallplateCaption' => 'Wall Plate',
            'wallplatePortCaption' => 'WP Port',
            'endpointCaption' => 'Endpoint',
            'endpointPortCaption' => 'EP Port',
            'endpointIp' => 'IP-Address',
            'endpointHostname' => 'Hostname',
            'endpointMac' => 'MAC-Address',
    ...
    function lang_en() {
        ...
        $lang['settings_config_server_desc'] = 'Controls global runtime options that are loaded directly from the .env file.';
        $lang['settings_config_log_level'] = 'Log level';
        $lang['settings_config_log_level_hint'] = '0=DEBUG, 1=INFO, 2=WARN, 3=ERROR, 4=NONE';
        $lang['settings_config_log_level_invalid'] = 'Log level must be between 0 and 4.';
